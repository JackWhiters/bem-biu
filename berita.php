                ...
                <ul class="nav__list">
                    ...
                    <li class="nav__item">
                        ...
                        <ul class="dropdown__nav">
                            <li><a href="tentang-kami.html" class="dropdown__link">Tentang BEM</a></li>
                            <li><a href="visi-misi.html" class="dropdown__link">Visi-Misi</a></li>
                            <li><a href="sejarah.html" class="dropdown__link">Sejarah</a></li>
                        </ul>
                    </li>
                    <li class="nav__item">
                        <a href="detail-berita.html" class="nav__link active-link">Berita & Program</a>
                    </li>
                    <li class="nav__item">
        ...
        <section class="detail-berita section">
            <div class="detail-berita__container container grid">
                <div class="detail__data">
                    <h2 class="detail__title">BERITA Papapsisi pasii sipaa sii.. Pasiipaa sisipapa sipapa si. Papa sisipasisi sipasii pa Pasii </h2>
        ...
        <section class="section berita container" id="berita">
            <div class="berita__link-container grid">
                <div class="berita__link-data">
                    <h2 class="berita__link-title">Pasiii... Sipapapasiipasipasi.. </h2>
                    <p class="berita__link-desc">-Pasiipapa pasipasi- Pasiii... Sipapapasiipasipasi.. Papapsisi pasii sipaa sii.. Pasiipaa sisipapa sipapa si. Papa sisipasisi sipasii pa Pasii... Papasiipasi Sipasiipasii papasipasiisisi papasi Pararapasipasii sipasi Pasiisipasipasi
                    </p>
