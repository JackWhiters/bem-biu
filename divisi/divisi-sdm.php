        ...
        <section class="detail-berita section">
            <div class="detail-berita__container container grid">
                <div class="detail__data">
                    <h2 class="detail__title">Divisi Sumber Daya Masyarakat</h2>
        ...
        <section class="section berita container" id="berita">
            <div class="berita__link-container grid">
                <div class="berita__link-data">
                    <h2 class="berita__link-title">Tentang Divisi Sumber Daya Masyarakat</h2>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Koor-divisi-pengembangan-dan-sdm"> Joy Featherstone F - FI 19A</h2>
                            <p class="desc__Koor-divisi-penelitian-dan-sdm">Koordinator Pengembangan dan SDM 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-pengembangan-dan-sdm"> Salsa Isyiyya - FI 19A</h2>
                            <p class="desc__Anggota-divisi-pengembangan-dan-sdm"> Anggota Pengembangan dan SDM 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-pengembangan-dan-sdm"> Adam Muzaki - FI 20A</h2>
                            <p class="desc__Anggota-divisi-pengembangan-dan-sdm"> Anggota Pengembangan dan SDM 2020-2021</p>
                          </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-pengembangan-dan-sdm"> Annisa Nurhalisa - FI 20A</h2>
                            <p class="desc__Anggota-divisi-pengembangan-dan-sdm"> Anggota Pengembangan dan SDM 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-pengembangan-dan-sdm"> Maria Leona Amelia - FB 20A</h2>
                            <p class="desc__Anggota-divisi-pengembangan-dan-sdm"> Anggota Pengembangan dan SDM 2020-2021</p>
                       </div>
                    </div> 
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-pengembangan-dan-sdm"> Nova - FB 20A</h2>
                            <p class="desc__Anggota-divisi-pengembangan-dan-sdm"> Anggota Pengembangan dan SDM 2020-2021</p>
                      </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-pengembangan-dan-sdm"> Riri Febriyanti - FB 20A</h2>
                            <p class="desc__Anggota-divisi-pengembangan-dan-sdm"> Anggota Pengembangan dan SDM 2020-2021</p>
                       </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-pengembangan-dan-sdm"> Ella Nurlela - FB 20A</h2>
                            <p class="Anggota-divisi-pengembangan-dan-sdm"> Anggota Pengembangan dan SDM 2020-2021</p>
                          </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__anggota-divisi-penelitian-dan-pkm"> Balyan Firman Ramadhan - FI 20A</h2>
                            <p class="desc__anggota-divisi-penelitian-dan-pkm"> Anggota Pengembangan dan SDM 2020-2021</p>
                         </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__anggota-divisi-penelitian-dan-pkm"> Yuliati - FI 20A</h2>
                            <p class="desc__anggota-divisi-penelitian-dan-pkm"> AnggotaPengembangan dan SDM 2020-2021</p>
                         </div>
                    </div>
            </div>
