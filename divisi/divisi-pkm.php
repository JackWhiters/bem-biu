...
<body>
    ...
    <main class="main">
        ...
        <section class="detail-berita section">
            <div class="detail-berita__container container grid">
                <div class="detail__data">
                    <h2 class="detail__title">Divisi Penelitian & PKM</h2>
        ...
        <section class="section berita container" id="berita">
            <div class="berita__link-container grid">
                <div class="berita__link-data">
                    <h2 class="berita__link-title">Tentang Divisi Penelitian dan PKM</h2>
        ...
        <section class="section visi__ukm container">
            <div class="visi__container grid">
                <div class="visi__ukm-data">
                    <h2 class="visi__ukm-title">Visi Divisi Penelitian dan PKM</h2>
                ...
                <div class="visi__ukm-data">
                    <h2 class="visi__ukm-title">Misi Divisi Penelitian dan PKM </h2>
                    <p class="visi__ukm-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                    <div class="order__visi">
                        <p class="order__details">1.</p>
                        <p class="order__details">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        ...
        <section class="member section" id="member">
            <h2 class="member__desc">Anggota & Pengurus Penelitian dan PKM </h2>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Koor-divisi-penelitian-dan-pkm"> Restu Amalia Novita - FI 19A</h2>
                            <p class="desc__Koor-divisi-penelitian-dan-pkm">Koordinator Penelitian dan PKM 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-penelitian-dan-pkm"> Dewi Ariana - FI 19A</h2>
                            <p class="desc__Anggota-divisi-penelitian-dan-pkm"> Anggota Penelitian dan PKM 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-penelitian-dan-pkm"> Mayjen Tomy S - FI 19A</h2>
                            <p class="desc__Anggota-divisi-penelitian-dan-pkm"> Anggota Penelitian dan PKM 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-penelitian-dan-pkm"> Andhika Prameswara - FI 20A</h2>
                            <p class="desc__Anggota-divisi-penelitian-dan-pkm"> Anggota Penelitian dan PKM 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-penelitian-dan-pkm"> Annisa Sholehah - FI 20A</h2>
                            <p class="desc__Anggota-divisi-penelitian-dan-pkm"> Anggota Penelitian dan PKM 2020-2021</p>
                       </div>
                    </div> 
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-penelitian-dan-pkm"> Barita Permana Pakpahan </h2>
                            <p class="desc__Anggota-divisi-penelitian-dan-pkm"> Anggota Penelitian dan PKM 2020-2021</p>
                         </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-penelitian-dan-pkm"> Kurnia Dewi - FB 20A</h2>
                            <p class="desc__Anggota-divisi-penelitian-dan-pkm"> Anggota Penelitian dan PKM 2020-2021</p>
                       </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-penelitian-dan-pkm"> Lim Nurhalimah - FI 19A</h2>
                            <p class="desc__Anggota-divisi-penelitian-dan-pkm"> Anggota Penelitian dan PKM 2020-2021</p>
                          </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-penelitian-dan-pkm"> Siti Nur Hamidah - FI 20A</h2>
                            <p class="desc__Anggota-divisi-penelitian-dan-pkm"> Anggota Penelitian dan PKM 2020-2021</p>
                         </div>
                    </div>
            </div>
...
<section class="program section container" id="program">
            <h2 class="divisi__title"> Program Kerja Divisi Penelitian dan PKM </h2>
            <div class="program__container grid">
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> Melakukan sosisalisasi dan Pelatihan PKM</p>
                        <h2 class="divisi__card-desc">  Program kreatif Mahasiswa</h2>
                    </div>
                ...
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> Mengadakan Webinar Karya Tulis Ilmiah </p>
                ...
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> Penelitian Terhadap Potensial UKM </p>
                        <h2 class="divisi__card-desc"> Unit Kegiatan Mahasiswa </h2>
                    </div>
                    <img src="assets/img/gambar-berita.jpeg" class="cards__program-img" alt="">
                </a>
            </div>
                    ...
                    <div class="detail__divisi-card">
                        <h2 class="detail__title-divisi"> dalam pengembangan sumber daya mahasiswa yang aktif,kreatif, dan berprestasi</h2>
                        <a href="#" class="button__program">Baca Selengkapnya
                        <i class="ri-arrow-right-s-line"></i>
                        </a>
                    </div>
                ...
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> Penelitian dan Pelatihan Kewirausahaan Bisnis dan IT </p>
                        <h2 class="divisi__card-desc"> Melalui program webinar </h2>
                    </div>
                    <img src="assets/img/gambar-berita.jpeg" class="cards__program-img" alt="">
                </a>
            </div>
