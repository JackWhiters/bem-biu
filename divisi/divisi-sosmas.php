...
<body>
    ...
    <main class="main">
        ...
        <section class="detail-berita section">
            <div class="detail-berita__container container grid">
                <div class="detail__data">
                    <h2 class="detail__title">Divisi Sosial Masyarakat</h2>
        ...
        <section class="section berita container" id="berita">
            <div class="berita__link-container grid">
                <div class="berita__link-data">
                    <h2 class="berita__link-title">Tentang Divisi Sosial Masyarakat</h2>
        ...
        <section class="section visi__ukm container">
            <div class="visi__container grid">
                <div class="visi__ukm-data">
                    <h2 class="visi__ukm-title">Visi Divisi Sosial Masyarakat </h2>
                ...
                <div class="visi__ukm-data">
                    <h2 class="visi__ukm-title">Misi Divisi Sosial Masyarakat </h2>
                    <p class="visi__ukm-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                    <div class="order__visi">
                        <p class="order__details">1.</p>
                        <p class="order__details">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        ...
        <section class="member section" id="member">
            <h2 class="member__desc">Anggota & Sosial Masyarakat   </h2>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Koor-divisi-sosial-Masyarakat"> Tsania Tasya - FB 19A</h2>
                            <p class="desc__Koor-divisi-sosial-masyarakat">Koordinator Sosial Mayarakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Ismail Marzuki - FI 19A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Ismail Putra - FI 19B</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Inta Dzuhri Nugroho - FI 19A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                         </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Bagas Adji Priantomo - FI 19A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                        </div>
                    </div> 
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Charles Wesley Tambunan - FI 19A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                      </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Marsya Ivani - FB 20A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                       </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Charles Wesley Tambunan - FI 20A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                          </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Naida Fadilah Lestari - FB 20A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Putri Barinda Shofiani - FB 20A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                         </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Putri Nayla Ulfa - FB 20A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                         </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Putri Nur Anggaeny - FB 20A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                         </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-sosial-masyarakat"> Salma Khairunnisa - FB 20A</h2>
                            <p class="desc__Anggota-divisi-sosial-masyarakat"> Anggota Sosial Masyarakat 2020-2021</p>
                         </div>
                    </div>
...
<!--==================== PROGRAM KERJA DIVISI SOSASIAL MASYARAKAT ====================-->
<section class="program section container" id="program">
            <h2 class="divisi__title"> Program Kerja Divisi Sosial Masyarakat </h2>
            <div class="program__container grid">
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> DOBMA </p>
                        <h2 class="divisi__card-desc">  Donor Darah Bersama Mahasiswa </h2>
                    </div>
                ...
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> Berkah Jumat  </p>
                ...
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> BiU Berkomunikasi  </p>
                        <h2 class="divisi__card-desc"> Untuk mewujudkan mahasiswa yang aktif dan inovatif </h2>
                    </div>
                    <img src="assets/img/gambar-berita.jpeg" class="cards__program-img" alt="">
                ...
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> Bina Desa  </p>
                        <h2 class="divisi__card-desc"> Untuk mewujudkan mahasiswa yang aktif dan inovatif </h2>
                    </div>
                    <img src="assets/img/gambar-berita.jpeg" class="cards__program-img" alt="">
                ...
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> BEMARKET  </p>
                        <h2 class="divisi__card-desc"> Untuk mewujudkan mahasiswa yang aktif dan inovatif </h2>
                    </div>
                    <img src="assets/img/gambar-berita.jpeg" class="cards__program-img" alt="">
                ...
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> Ramadhan Peduli  </p>
                        <h2 class="divisi__card-desc"> Untuk mewujudkan mahasiswa yang aktif dan inovatif </h2>
                    </div>
                    <img src="assets/img/gambar-berita.jpeg" class="cards__program-img" alt="">
                ...
                <div class="program__card">
                    <div class="detail__divisi">
                        <p class="divisi__card-title"> Taman Baca  </p>
                        <h2 class="divisi__card-desc"> Untuk mewujudkan mahasiswa yang aktif dan inovatif </h2>
                    </div>
                    <img src="assets/img/gambar-berita.jpeg" class="cards__program-img" alt="">
