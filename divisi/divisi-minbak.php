        ...
        <section class="section visi__ukm container">
            <div class="visi__container grid">
                <div class="visi__ukm-data">
                    <h2 class="visi__ukm-title">Visi Divisi Minat dan Bakat</h2>
                ...
                <div class="visi__ukm-data">
                    <h2 class="visi__ukm-title">Misi Divisi Minat dan Bakat </h2>
                    <p class="visi__ukm-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                    <div class="order__visi">
                        <p class="order__details">1.</p>
                        <p class="order__details">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__koor-divisi-minat-dan-bakat"> Anisah - FB 19A</h2>
                            <p class="desc__koor-divisi-minat-dan-bakat">Koordinator Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-minat-dan-bakat"> Dena Handayani - FI 19A</h2>
                            <p class="desc__Anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-minat-dan-bakat"> Titi Farhah - FB 19A</h2>
                            <p class="desc__Anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-minat-dan-bakat"> Rizki Fadhillah Muhammad Habibi - FI 19A</h2>
                            <p class="desc__Anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-minat-dan-bakat">Faiq Sastra Dinata - FI 19A</h2>
                            <p class="desc__Anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div> 
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-minat-dan-bakat"> Diana Prihatiningsih - FB 19A</h2>
                            <p class="desc__Anggota-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__anggota-divisi-minat-dan-bakat"> Desi Damayanti - FB 20A</h2>
                            <p class="desc__anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__anggota-divisi-minat-dan-bakat"> Gilang Mukti Setio Bekti - FI 19A</h2>
                            <p class="desc__anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-minat-dan-bakat"> Leliana Eka Fauziah - FI 20A</h2>
                            <p class="desc__Anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-minat-dan-bakat"> Muhammad Achyar Rameci - FI 20A</h2>
                            <p class="desc__Anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-minat-dan-bakat"> Tryas Yulita Ichsanti - FI 20A</h2>
                            <p class="desc__Anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div> 
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-minat-dan-bakat"> Amelia Putri Sugesti - FB 20A</h2>
                            <p class="desc__Anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div> 
                    ...
                    <div class="swiper-slide member-card">
                        <div class="member__card-content">
                            ...
                            <h2 class="nama__Anggota-divisi-minat-dan-bakat"> Nabila Rodhatul Jannah - FIB20A</h2>
                            <p class="desc__Anggota-divisi-minat-dan-bakat"> Anggota Minat Dan Bakat 2020-2021</p>
                        </div>
                    </div> 
            </div>
